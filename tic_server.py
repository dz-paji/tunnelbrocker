...
class TicServer():
    ...
    def run(self):
        ...
        while True:
            ...
            threading.Thread(target=self.clientThread, args=(conn, addr, False)).start()
                        
    def clientThread(self, conn: socket.socket, addr: str, isTLS: bool):
    ...
    def formatTunnelShow(self, i:TunnelEntity) -> str:
        ...
        resp_msg += f"UserState: {i.user_state}\n"
